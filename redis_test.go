...
func TestRedisWithCustomRunOptions(t *testing.T) {
	...
	client, cleanup := dockertestx.NewRedisWithOptions(t, []dockertestx.RunOption{customTag})
	defer cleanup()
...
func TestRedisWithCustomHostOptions(t *testing.T) {
	...
	client, cleanup := dockertestx.NewRedisWithOptions(t, nil, autoRemove)
	defer cleanup()
...
func TestRedisDataTypes(t *testing.T) {
	...
	t.Run("List", func(t *testing.T) {
		...
		if err := dockertestx.PrepRedisList(t, client, key, values); err != nil {
	...
	t.Run("Hash", func(t *testing.T) {
		...
		if err := dockertestx.PrepRedisHash(t, client, key, fields); err != nil {
	...
	t.Run("Set", func(t *testing.T) {
		...
		if err := dockertestx.PrepRedisSet(t, client, key, members); err != nil {
	...
	t.Run("SortedSet", func(t *testing.T) {
		...
		if err := dockertestx.PrepRedisSortedSet(t, client, key, members); err != nil {
	...
	t.Run("Expiration", func(t *testing.T) {
		...
		if err := dockertestx.PrepRedis(t, client, items, time.Second); err != nil {
